    ...
    partial class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var connection = new SQLiteConnection(string.Format(configuration?["ConnectionStrings:DefaultConnection"] ?? "", configuration?["DatabaseFileName"])))
            {
                ...
                detailCmd.CommandText = "INSERT INTO Document (Id, FileNumber, Name, FilePath, Length, AccountId) VALUES(@Id, @FileNumber, @Name, @FilePath, @Length, @AccountId)";
                var detailId = detailCmd.Parameters.Add("@Id", System.Data.DbType.Int32);
                var FileNumber = detailCmd.Parameters.Add("@FileNumber", System.Data.DbType.Int32);
                ...
                var detailAccountId = detailCmd.Parameters.Add("@AccountId", System.Data.DbType.Int32);
                detailCmd.Prepare();
